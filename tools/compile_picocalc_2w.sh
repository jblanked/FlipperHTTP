#!/bin/bash
# Compile FlipperHTTP for PicoCalc 2W (Raspberry Pi Pico 2W with TFT display)
...
BOARD_DEF="BOARD_PICOCALC_2W"
BOARD_VAL="13"

echo "=== FlipperHTTP Compiler for PicoCalc 2W ==="
echo ""
...
[ -f "flipper-http.ino.uf2" ] && mv "flipper-http.ino.uf2" "flipper_http_picocalc_2w.uf2" && echo "✓ flipper_http_picocalc_2w.uf2"
