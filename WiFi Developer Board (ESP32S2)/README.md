...
9. Connect your WiFi Developer Board into the Flipper then turn on your Flipper. (Optionally, turn on your Flipper first. Then, hold the `BOOT` button while connecting your WiFi Developer Board. You may also need to briefly hold the `EN/Reset` button before releasing the `BOOT` button. If you do this, when you get to step 11, you can skip the `Reset Board` and `Enter Bootloader` steps.)
